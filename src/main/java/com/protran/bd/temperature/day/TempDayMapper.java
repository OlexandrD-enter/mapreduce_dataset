...
public class TempDayMapper extends Mapper<LongWritable, Text, Text, FloatWritable> {
    private String userDateBefore;
    private String userDateAfter;
    private final static TempDayMapper INSTANCE = new TempDayMapper();

    private TempDayMapper() {}

    public static TempDayMapper getInstance() {
        return INSTANCE;
    }
