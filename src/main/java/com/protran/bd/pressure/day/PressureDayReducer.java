...
public class PressureDayReducer extends Reducer<Text, FloatWritable, Text, NullWritable> {
    ...
    protected void reduce(Text key, Iterable<FloatWritable> floatTypes, Context context)
        ...
        context.write(new Text("Day " + key + " avg_pressure " + sum / counter), nullWritable);
    }
