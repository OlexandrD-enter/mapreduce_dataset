...
public class PressureMonthDriver extends Configured implements Tool
{
    public int run(String[] arg0) throws Exception
    {
        try
        {
            ...
            job.setMapperClass(PressureMonthMapper.class);
            job.setMapOutputKeyClass(Text.class);
            job.setMapOutputValueClass(FloatWritable.class);

            job.setReducerClass(PressureMonthReducer.class);
           ...
           /* if (fs.exists(new Path(arg0[1] + " month " + before + " - " + after)))
            ...
            FileOutputFormat.setOutputPath(job, new Path(arg0[1] + "_pressure_month_" + before + "_" + after));
    ...
    {
        ToolRunner.run(new PressureMonthDriver(), args);
    }
}
